...
class TestElvTextFile(unittest.TestCase):
    ...
    def test_read_text_file(self):
        ...
        with open(self.elv_text_file_path, 'r', encoding="UTF-16") as elv_text_file:
            ...
            self.assertEqual("0.0mm", elv_text_parameters.sample_height)
            ...
            self.assertEqual("7eV", elv_text_parameters.energy_width)
            self.assertEqual("0.0eV", elv_text_parameters.energy_loss)
            self.assertEqual("500µs", elv_text_parameters.speed)
