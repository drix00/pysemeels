...
class TestSimulationData(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        with open(self.ana_file_path, 'r') as elv_text_file:
            ...
            self.assertEqual("10:59", ana_file.time)
            self.assertEqual("", ana_file.comment)
            self.assertEqual("500µs", ana_file.dose)
            ...
            self.assertEqual(0, ana_file.h4)
            ...
            self.assertEqual(-1500, ana_file.det_spec_alignment_x)
            self.assertEqual(470, ana_file.det_spec_alignment_y)
            ...
            self.assertEqual(2282, ana_file.counts[0])
            ...
            self.assertEqual(0.918375, ana_file.gain_corrections[0])
            self.assertEqual(0.000000, ana_file.gain_corrections[-1])
            self.assertEqual(1024, len(ana_file.gain_corrections))

            self.assertEqual(2313, ana_file.dark_currents[0])
